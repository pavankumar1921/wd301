    ...
    <div>
      ...
      <div className="grid grid-cols-5">
        <div className="TaskCell col-start-2 col-span-1 rounded">
          ...
          <TaskCard title="Build the website with static content" dueDate="10th April" assigneeName="Pavan Kumar" statusOfTask="pending"/>
          <TaskCard title="Add a blog" dueDate="22nd March" assigneeName="Sandeep" statusOfTask="pending"/>
        ...
        <div className="TaskCell col-start-4 col-span-1">
          ...
          <TaskCard title="Design the mockup" completedAtDate="10th April" assigneeName="Nithin" statusOfTask="completed"/>
          <TaskCard title="Get the appproval from principal" completedAtDate="20th April" assigneeName="Vineeth" statusOfTask="completed" />
        </div>  
      </div>
    </div>
  )
