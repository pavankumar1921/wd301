    ...
    <div>
      ...
      <div className="grid grid-cols-5">
        <div className="TaskCell col-start-2 col-span-1 rounded">
          ...
          <TaskCard title="Build the website with static content" dueDate="10th April" assigneeName="Pavan Kumar" />
          <TaskCard title="Add a blog" dueDate="18th April" assigneeName="Sandeep" />
        ...
        <div className="TaskCell col-start-4 col-span-1">
          ...
          <TaskCard title="Design the mockup" completedAtDate="10th May" assigneeName="Nithin" />
          <TaskCard title="Get the appproval from principal" completedAtDate="12th August" assigneeName="Vineeth" />
        </div>  
      </div>
    </div>
  )
